                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="post-thumb" style="width: 100%">
                            <img src="{{ $post->featured }}" style="width: 100%" alt="{{ $post->slug }}">
                        </div>
                            ...
                            <div class="post-additional-info">
                                ...
                                <div class="post__author author vcard">
                                    ...
                                    <div class="post__author-name fn">
                                        <a href="{{ asset($post->user->profile->avatar) }}"  class="post__author-link">{{ $post->user->name }}</a>
                                    </div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ asset($post->user->profile->avatar) }}" style="width: 70px" alt="{{ $post->user->name }}">
                        </div>
