    ...
    <div class="container">
            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $last_post->featured }}" style="width: 100%" alt="{{ $last_post->slug }}">
                        <div class="overlay"></div>
                        <a href="{{ $last_post->featured }}" class="link-image js-zoom-image">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title text-center">
                                <a href="{{ route('post.single',['slug' => $last_post->slug]) }}">{{ $last_post->title }}</a>
                            </h2>
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            ...
                                            <a href="{{ route('category.single',['id' => $last_post->category->id]) }}">{{ $last_post->category->name }}</a>
                                        </span>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    <div class="post-thumb">
                        <img src="{{ $second_post->featured }}" style="width: 100%" alt="{{ $second_post->slug }}">
                        <div class="overlay"></div>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{ $third_post->featured }}" style="width: 100%" alt="{{ $third_post->slug }}">
                        <div class="overlay"></div>
