                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">
                            if U want U can add here text(add about field in the settings table)
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{ $settings->site_phone }}</a>
                            <p class="sub-title">work hours</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">or U can add site address field</p>
                        </div>
                    </div>
                </div>
            </div>
